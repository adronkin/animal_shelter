# Generated by Django 2.2.5 on 2019-09-30 17:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('core_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='mainapp.Core')),
                ('pet_status', models.CharField(choices=[('SOS', 'Нужна помощь'), ('SCK', 'На лечении'), ('RDY', 'Можно забрать'), ('HME', 'Уже дома')], default='SCK', max_length=3, verbose_name='статус')),
                ...
                ('pet_breed', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.Breed')),

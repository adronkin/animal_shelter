...
class Category_type(Core):
    # Картинка категории

    """Класс описывающий вид животного"""

class Category_health(Core):
    # Картинка категории

    """Класс описывающий состояние здоровья животного"""
...
class PetCity(Core):
    """Город, в котором находится питомец"""
...
class Pet(Core):
    ...
    pet_category_type = models.ForeignKey(Category_type, on_delete=models.CASCADE, blank=True, null=True)
    pet_category_health = models.ForeignKey(Category_health, on_delete=models.CASCADE, blank=True, null=True)
    ...
    pet_city = models.ForeignKey(PetCity, on_delete=models.CASCADE, blank=True, null=True)
